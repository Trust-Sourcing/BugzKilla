(function () {
    ...
    if (window.routeController.partName == 'tool') {
        ...
        var assemblaController = {
            ...
            createTicketAjax: function (data) {
                ...
                $.ajax({
                    ...
                    if (helpers.sourceOrigin.length > 0) {
                        parent.postMessage(pin, helpers.sourceOrigin);
                        parent.postMessage('renewButton', helpers.sourceOrigin);
                    }
        ...
        var tool = {
            ...
            initSlider: function () {
                ...
                self.slySlider = new Sly($('.js-slideFrame'), {
                    ...
                    speed: 600,
                    startAt: 0,
                    prevPage: $('.btn-slider.prev'),
                    nextPage: $('.btn-slider.next')
                }).init();
            },
            ...
            postMessageSenderToExternalSource: function (message) {
                if (message.data === 'loading') {
                    helpers.sourceOrigin = message.origin;
                    helpers.launchLoader();
                    helpers.getScreenFromParent();
                }
            },
            ...
            bindEvents: function () {
                ...
                window.addEventListener('message', self.postMessageSenderToExternalSource, false);
                ...
                $(".side-bar-detect.active").click(function () {
                    $('body').css('cursor', "crosshair");
        ...
        $(document).ready(function () {
            ...
            $(".side-bar-detect.active").trigger('click');
        });
